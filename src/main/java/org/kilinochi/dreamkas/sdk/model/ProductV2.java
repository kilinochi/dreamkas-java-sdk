 ...
 */
public class ProductV2 implements DreamkasSerializable {
    @NotNull
    private @Valid final UUID id;
    @NotNull
    private @Valid final String name;
    @NotNull
    private @Valid final ProductTypeV2 type;
    @NotNull
    ...
    public ProductV2(
            ...
            @NotNull @JsonProperty("tax") @Valid TaxV2 tax,
